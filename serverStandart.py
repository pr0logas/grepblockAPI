...
api = Api(app, prefix="/apiv1/standart")
auth = HTTPBasicAuth()
...
''' http://127.0.0.1:5000/apiv1/standart/block?num=123&assetname=adeptio '''
...
''' /apiv1/standart/wallet?addr=Aa1Cgn1949UvoZHXRrBVYuihUUL3K6ARPn&assetname=adeptio '''
